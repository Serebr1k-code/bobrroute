...
export default function CustomCliCard({
  ...
  const keyToUse =
    ...
    (!cloudEnabled
      ? "sk_bobrroute"
      : translateOrFallback("yourApiKeyPlaceholder", "sk-your-bobrroute-key"));
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="mt-2 text-xs text-text-muted">
                  {translateOrFallback(
                    "customCliKeyHelper",
                    "For local installs OmniRoute can use sk_bobrroute. In cloud mode, pick one of your management API keys."
                  )}
                </p>
              </div>
            </div>
