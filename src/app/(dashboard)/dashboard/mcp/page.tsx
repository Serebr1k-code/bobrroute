...
function TransportSelector({
  ...
  const options: { value: McpTransport; label: string; desc: string }[] = [
    { value: "stdio", label: "stdio", desc: "Local — IDE spawns process via bobrroute --mcp" },
      ...
      <Card>
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            >
              <li>
                Run via <code className="text-xs">bobrroute --mcp</code>
              </li>
              <li>Configure your MCP client to connect over stdio transport.</li>
              <li>
                Invoke tools like <code className="text-xs">bobrroute_get_health</code> and{" "}
                <code className="text-xs">bobrroute_list_combos</code>.
              </li>
            </ol>
          </div>
